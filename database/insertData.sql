...
-- 2. Insertar usuarios
INSERT INTO USUARIOS (NOMBRE, A_PATERNO, A_MATERNO, CORREO, CONTRASEÑA, ID_TIPO_USUARIO) VALUES ('Juan', 'Pérez', 'Gómez', 'juan.perez@example.com', 'password', 1);
INSERT INTO USUARIOS (NOMBRE, A_PATERNO, A_MATERNO, CORREO, CONTRASEÑA, ID_TIPO_USUARIO) VALUES ('Ana', 'López', 'Martínez', 'ana.lopez@example.com', 'password', 2);
INSERT INTO USUARIOS (NOMBRE, A_PATERNO, A_MATERNO, CORREO, CONTRASEÑA, ID_TIPO_USUARIO) VALUES ('Carlos', 'Ramírez', 'Sánchez', 'carlos.ramirez@example.com', 'password', 1);
INSERT INTO USUARIOS (NOMBRE, A_PATERNO, A_MATERNO, CORREO, CONTRASEÑA, ID_TIPO_USUARIO) VALUES ('María', 'Fernández', 'Rodríguez', 'maria.fernandez@example.com', 'password', 2);
INSERT INTO USUARIOS (NOMBRE, A_PATERNO, A_MATERNO, CORREO, CONTRASEÑA, ID_TIPO_USUARIO) VALUES ('Lucía', 'Navarro', 'García', 'lucia.navarro@example.com', 'password', 1);
INSERT INTO USUARIOS (NOMBRE, A_PATERNO, A_MATERNO, CORREO, CONTRASEÑA, ID_TIPO_USUARIO) VALUES ('Pedro', 'González', 'Torres', 'pedro.gonzalez@example.com', 'password', 2);
INSERT INTO USUARIOS (NOMBRE, A_PATERNO, A_MATERNO, CORREO, CONTRASEÑA, ID_TIPO_USUARIO) VALUES ('Sofía', 'Hernández', 'Lopez', 'sofia.hernandez@example.com', 'password', 1);
INSERT INTO USUARIOS (NOMBRE, A_PATERNO, A_MATERNO, CORREO, CONTRASEÑA, ID_TIPO_USUARIO) VALUES ('Miguel', 'Cruz', 'Mendoza', 'miguel.cruz@example.com', 'password', 2);
INSERT INTO USUARIOS (NOMBRE, A_PATERNO, A_MATERNO, CORREO, CONTRASEÑA, ID_TIPO_USUARIO) VALUES ('AAA', 'BBB', 'CCC', 'aaa.bbb@example.com', 'password', 2);
